...
public class Example {
    public static void main(String[] args) {
        ...
        MyForcasterInterface forecaster = new CachingWeatherForcaster(new MyForcasterAdapter());

        //forecaster.forecastFor(Region.LONDON, Day.MONDAY);
        ...
        edinburghForecast = forecaster.forecastFor(Region.EDINBURGH, Day.MONDAY);
